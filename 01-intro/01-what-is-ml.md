...
In summary, ML is a process of **extracting patterns from data** to train a model and use it to predict unknown object of the same category. There are two main inputs for ML:

1. Features (information about the object)
2. Target/Label (property to predict for unseen objects)
